...
import { Star, Clock, Hotel, Plane, ShieldCheck, X, FileText, CheckCircle2, ChevronLeft, ChevronRight, Phone, MapPin, Globe, MessageSquare } from 'lucide-react';
...
const PACKAGES = [
  ...
  },
  {
    ...
    itinerary: [
      "Hari 1: Berkumpul di Bandara International Soekarno Hatta Terminal 2F (5 jam sebelum keberangkatan) briefing dan check-in pesawat. Landing bandara King Abdul Aziz, Jeddah. Proses Imigrasi dan Bagasi. Jamaah Menuju Hotel Madinah by Bus dan Check In Hotel Madinah dan Istirahat.",
      "Hari 2: Qiyamulail dan sholat subuh di Masjid Nabawi. Berziarah ke Makam Nabi Muhammad ﷺ (Raudhah : tergantung jadwal dari Muasasah). dan pengenalan sekitar Masjid Nabawi (Pemakaman Baqi, Saqifah Bani Saidah, Masjid Abu Bakar, Masjid Ghomamah, Masjid Ali).",
      "Hari 3: Qiyamulail dan sholat subuh di Masjid Nabawi. Setelah Sarapan, Pukul 07.00 Jamaah bersiap untuk City Tour Percetakan Al-Qur’an dan Madinah (Masjid Quba, Masjid Qiblatain, Jabal Uhud, Masjid Khandak dan Kebun/Pasar Kurma).",
      "Hari 4: Memperbanyak ibadah di Masjid Nabawi.",
      "Hari 5: Qiyamulail dan sholat subuh berjamaah di Masjid Nabawi dan Ziarah Wada’. Sarapan pagi dan Pukul 08.00 Jamaah diminta untuk mengeluarkan koper dari kamar masing-masing. Pelaksanaan Sholat Jum’at. Checkout hotel. Miqot Bir Ali, Jamaah Menuju Hotel Makkah by Bus dan Check In Hotel. Pelaksanaan Umroh Wajib.",
      "Hari 6: Qiyamulail di Masjidil Haram. Jamaah diberikan waktu bebas untuk memperbanyak Ibadah, seperti Tadarus Alquran, berdzikir, Itikaf dan Amalan Sunnah lainnya. Pelaksanaan Umroh pertama.",
      "Hari 7: Setelah sarapan Jamaah kemudian bersiap-siap untuk City Tour Makkah (Jabal Tsur, Arafah, Jabal Rahmah, Muzdalifah, Mina, Jabal Nur, dan tempat Miqot Ji’ronah) dan diwajibkan membawa kain ihrom untuk melaksanakan ibadah umroh kedua.",
      "Hari 8: Qiyamulail dan sholat subuh di Masjidil Haram Sarapan pagi dan Pukul 08.00 Jamaah diminta untuk mengeluarkan koper dari kamar masing-masing. THAWAF WADA’. Pukul 14.00 Checkout hotel. Jamaah Menuju bandara.",
      "Hari 9: Terbang menuju Cairo menggunakan pesawat Saudia Airlines. Proses Imigrasi dan Bagasi dilanjutkan menuju hotel.",
      "Hari 10: Sarapan pagi City Tour ke Pyramid & Sphinx, Ziarah Imam Syafi’i, Sholahuddin Fort, Al Sayeda Zeinad Mosque, Al Hussein Mosque, Al Azhar Mosque, Dinner Nile Night.",
      "Hari 11: Sarapan pagi dan check out hotel. City Tour Egyptian Museum, Tutankhamen Collection Treasure, Cairo Citadel, Mohammad Ali Mosque. Setelah itu Jamaah menuju Jeddah menggunakan Saudia Airlines.",
      "Hari 12: Tiba di Jeddah dan proses perpindahan gate. Akan melanjutkan perjalanan menuju Jakarta menggunakan Saudia Airlines dan di tiba di terminal 2F Bandara Soekarno Hatta. Sampai bertemu di umroh berikutnya dan semoga mendaptkan pahal umroh Maqbuloh...Aamiin ."
    ],
    inclusions: ["Visa Umrah Resmi & Asuransi KSA", "Visa Mesir (Egypt Visa on Arrival diurus panitia)", "Tiket Pesawat PP Saudia Airlines / Qatar Airways / Emirates", "Hotel Bintang 4: Royal Andalus Madinah, Elaf Al Bait & Front Pyramid", "Bus AC Eksklusif (Madinah-Makkah & di Mesir)", "Tour Leader & Mutawwif Berpengalaman", "Pemandu Wisata Lokal Mesir (berbahasa Indonesia)", "Katering 3x Sehari (Tanah Suci) + Makan siang & malam (Mesir)", "City Tour Sejarah Mesir (Piramida Giza, Sphinx & Museum Mesir, dll)", "Perlengkapan Umrah Lengkap (koper, ihram/mukena, dll)", "Air Zamzam 5 Liter"],
  ...
  },
  {
    ...
    hotelStars: 4,
    badge: "Januari 2027",
    tagline: "Nisfu Syaban di Masjid Nabawi.",
    brosurUrl: "https://wa.me/6287771000018?text=Assalamualaikum%20Ichsan%20Kamil%2C%20saya%20ingin%20meminta%20brosur%20paket%20Umrah%20Spesial%20N  isfu%20Syaban%20(Rp%2036.500.000)",
    highlights: ["2x Sholat Jumat di 2 Kota Suci", "Ticket Confirm", "Free Albaik", "Free Zam-Zam 5 Liter", "Percetakan Al-Qur'an"],
    itinerary: [
      "Hari 1: Berkumpul di PT Ichsan Kami pelepasan dan menuju Bandara Terminal 2F (5 jam sebelum keberangkatan). Sarapan, briefing dan check-in pesawat. Takeoff By Saudia Airlines Take Off menuju Jeddah. Landing dan Menuju hotel beristirahat sejenak, persiapan pelaksaaan Umroh Ke-1 (Miqot Umroh ke-1 dilakukan di pesawat atau dibandara melihat situasi dan kondisi).",
      "Hari 2: Qiyamullail dan memperbanyak ibadah di Masjidil Haram, sarapan pagi dan persiapan sholat jum’at serta kegiatan pribadi Jamaah diberikan waktu bebas untuk memperbanyak Ibadah, seperti Tadarus Alquran, berdzikir, Itikaf dan Amalan Sunnah lainnya.",
      "Hari 3: Qiyamulail dan memperbanyak ibadah di Masjidil Haram. Sarapan pagi dan Jamaah kumpul di lobby pukul 07.00 (on-time) persiapan City Tour Kota Makkah (Jabal Tsur, Padang Arafah, Jabal Rahmah, Muzdhalifah, Mina, Jabal Nur, Ji’Rona) dan Miqot Umroh ke-2 serta pelaksanaan Umroh ke-2  (diwajibkan membawa pakaian ihram).",
      "Hari 4: Qiyamullail dan memperbanyak ibadah di Masjidil Haram, sarapan pagi dan kegiatan pribadi Jamaah diberikan waktu bebas untuk memperbanyak Ibadah, seperti Tadarus Alquran, berdzikir, Itikaf dan Amalan Sunnah lainnya.",
      "Hari 5: Qiyamulail dan memperbanyak ibadah di Masjidil Haram. Sarapan pagi dan  Jamaah kumpul di lobby pukul 07.00 (on-time) persiapan City Tour Thaif (Masjid Abdullah Bin Abbas, Masjid Al-Ku/’aa. Pabrik Parfum, Cable Car/Kereta Gantung dan Makan siang khas Arab) dan Miqot Umroh ke-3 untuk  pelaksanaan Umroh ke-3 (Mandiri) (diwajibkan membawa pakaian ihram).",
...
export default function PackageGrid({ filters, onResetFilters, openPackageId, onPackageDetailClosed }) {
  ...
  useEffect(() => {
    // Initial check & setup event listeners
          ...
          <div className="relative group/slider">
            ...
            {canScrollLeft && (
              <button
                ...
                className="absolute -left-3 sm:-left-6 top-1/2 -translate-y-1/2 z-20 w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-white/95 shadow-xl border border-gold/30 flex items-center justify-center text-maroon hover:bg-maroon hover:text-white hover:scale-110 transition-all duration-200"
            ...
            {canScrollRight && (
              <button
                ...
                className="absolute -right-3 sm:-right-6 top-1/2 -translate-y-1/2 z-20 w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-white/95 shadow-xl border border-gold/30 flex items-center justify-center text-maroon hover:bg-maroon hover:text-white hover:scale-110 transition-all duration-200"
            ...
            <div
              ...
              className="flex gap-6 overflow-x-auto scroll-smooth py-4 px-1 snap-x snap-mandatory [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
            >
              {filteredPackages.map((pkg) => (
                <div
                  key={pkg.id}
                  className={`flex-shrink-0 w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] snap-start bg-white rounded-3xl overflow-hidden shadow-lg border border-maroon/5 transition-all duration-300 flex flex-col group relative ${pkg.isSoldOut
            ...
            {/* Hint text for mobile & multiple items */}
            {filteredPackages.length > 1 && (
              <p className="text-center mt-3 text-xs text-charcoal/50 flex items-center justify-center gap-1 sm:hidden">
                <span>← Geser layar ke samping untuk melihat paket lainnya →</span>
              </p>
            )}
          </div>
        ) : (
